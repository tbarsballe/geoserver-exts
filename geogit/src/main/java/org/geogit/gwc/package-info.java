/**
 * Package {@code org.geogit.gwc} integrates GeoServer configured geogit data stores with GeoWebCache.
 * <p>
 * <H2>Truncate GWC tiles<H2>
 * <p>
 * The {@link org.geogit.gwc.TruncateTilesOnUpdateRefHook} command hook is declared 
 * in {@code src/main/resources/META-INF/services/org.geogit.api.hooks.CommandHook}, following GWC's 
 * SPI mechanism to declare "classpath" command hooks.
 * <p>
 * This command hook captures calls to {@link org.geogit.api.plumbing.UpdateRef} commands in any
 * configured {@link org.geogit.geotools.data.GeoGitDataStore geogit datastore}, and figures out
 * which {@link org.geoserver.gwc.layer.GeoServerTileLayer tile layers} would be affected by the change.
 * <p>
 * For the affected tile layers, the {@link org.geogit.gwc.MinimalDiffBounds} command is used to compute
